...
"""
column!(F!, B!, xk, ε, itmax, mstlen, verbose)
...
"""
function column!(F!, B!, xk, vec, ε::Float64=(10.0 ^ (-8.0)), itmax::Int64=500, mstlen::Float64=10.0^(- 8.0), verbose::Bool=true)
    ...
    while normfk > ε
        ...
        append!(e, findfirst(isequal(norm(ak, Inf)), abs.(ak)))
