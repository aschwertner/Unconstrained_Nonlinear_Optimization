...
"""
fixednewtonrestart!(F!, J!, xk, d, ε, itmax, mstlen, verbose)

# ARGUMENTS
- 'F!::Function': Objective Function.
- 'J!::Function': Jacobian matrix of F!.
- 'xk::Array(1-dimensional)': Initial point.
- 'd::Integer': Number of iterations between two factorizations of Jacobian matrix.
- 'ε::Float': Tolerance.
...
"""
function fixednewtonrestart!(F!, J!, xk, vec, d::Int64, ε::Float64=(10.0 ^ (-8.0)), itmax::Int64=500, mstlen::Float64=10.0^(- 8.0), verbose::Bool=true)
